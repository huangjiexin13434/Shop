...
<script type="text/javascript">
	...
	function checkForm(){
		...
		if(username!="" && password!=""){
			...
			myform.action="${pageContext.request.contextPath }/user?method=login&username="+username+"&password="+password;
		}
		return flag;
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<div>&nbsp;</div>
					<form id="myform"  onsubmit="return checkForm()"  method="post" class="form-horizontal">
