...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form class="form-horizontal" id="orderForm" action="${pageContext.request.contextPath }/order"
				style="margin-top: 5px; margin-left: 150px;">
				<div class="form-group">
					<input type="hidden" value="confirmOrder" name="method" id="method">
					<input type="hidden" value="${order.oid }" name="oid" id="oid">
			...
			<div style="margin-top: 5px; margin-left: 150px;">
				...
				<p style="text-align: right; margin-right: 100px;">
					<input value="" type="submit" style="width:204px; height:51px; background-image:url('./images/finalbutton.gif'); ">
