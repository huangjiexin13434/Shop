			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<img alt="" src="${pageContext.request.contextPath}/${product.pimage}" width="50">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						...
						<c:forEach items="${categorieList}" var="category">
							<c:if test="${product.category==category.cid }">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<textarea name="pdesc"  rows="7" cols="30">${product.pdesc}</textarea>
					</td>
				</tr>
				<tr>
